...
dimensions = [10240]
files = ['emgp','emgpp','emgppp','emgpppp','emgppppp']
#,'mnist', 'voicehd']
train_size = [368, 345, 338, 333, 235]
#, 60000, 6238]
test_size = [158, 148, 145, 143, 101]
# 10000, 1559]
vector_size = 128
num_threads = 4
type_exec = ['PARALLEL']
...
with open(folder + out_file + now, "+a") as output:
    output.write('Application,Dimensions,Time,Accuracy,Memory,Vectorial,Parallel,Performance\n')
            ...
            for vec in vectorial:
                for par in type_exec:
                    for dim in dimensions:
                        ...
                        lines.append('.PERFORMANCE ' + str(per) + ';\n')
