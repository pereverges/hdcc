...
num_threads, vector_size, type, input_dim, high, basic, padding, permutes, ngram, not_multiset, vectorial, performance = ast.get_ast_obj()
...
ir = IntermediateRepresentation(name, classes, dimensions, used_vars, weight, encoding, embeddings, debug,
                                ...
                                high, basic, padding, permutes, ngram, path, not_multiset, vectorial, performance)
